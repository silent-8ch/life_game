...
Last audited against the repo at `6ab4be2`.
...
**`main` at `6ab4be2` is green, verified here.** The whole gate, run against `main` rather
than against a branch: eslint, prettier, tsc, pint and phpstan all pass, **6 component tests**
under Vitest, Pest **345 of 345, 2407 assertions, 45s**.

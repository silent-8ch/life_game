...
Last audited against the repo at `2712293`.
...
**`main` at `6b852a2` is green, verified here.** The whole gate, run against `main` rather
than against a branch: eslint, prettier, tsc, pint and phpstan all pass, Pest **321 of 321,
2336 assertions, 35s**.
